...
object Driver {
  ...
  /**
    ...
    * @return           Returns true if all tests in testerGen pass
    */
  def execute[T <: RawModule](args: Array[String], dut: () => T)(
    testerGen: T => PeekPokeTester[T]
  ): Boolean = {
  ...
  /**
    ...
    * @return
    */
  def executeFirrtlRepl[T <: RawModule](
                                      dutGenerator: () => T,
 ...
 *
  ...
  /**
    ...
    */
  def run[T <: RawModule](dutGen: () => T, cmd: Seq[String])
                      (testerGen: T => PeekPokeTester[T]): Boolean = {
  ...
  def run[T <: RawModule](dutGen: () => T, binary: String, args: String*)
                      (testerGen: T => PeekPokeTester[T]): Boolean =
    run(dutGen, binary +: args.toSeq)(testerGen)

  def run[T <: RawModule](dutGen: () => T, binary: File, waveform: Option[File] = None)
                      (testerGen: T => PeekPokeTester[T]): Boolean = {
